...
// Cartão de destaque com animação no hover
// Props: ícone, título e texto descritivo
export default function FeatureCard({ icon, title, text }: { icon: ReactNode; title: string; text: string }) {
    return (
        <motion.div
            // Efeito de leve ampliação ao passar o mouse
        ...
        >
            {/* Ícone em destaque na cor dourada */}
